				...
				<div class="col-md-6 col-lg-7 p-b-30">
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
                           ...
                           @php($image=json_decode($products->image))
							...
							<div class="slick3 gallery-lb">
								...
								<div class="item-slick3" data-thumb="{{ asset('product/'.$img)}}">
									...
									<div class="wrap-pic-w pos-relative">
										...
										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{ asset('product/'.$img)}}">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="size_id">
											...
											<option value="{{$products->size_id}}">{{$products->size->size_name}}</option>
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select class="js-select2" name="color_id">
											...
											<option value="{{$products->color_id}}">{{$products->color->color_name}}</option>
