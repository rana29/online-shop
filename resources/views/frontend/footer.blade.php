			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-6 p-b-50">
					...
					<ul class="social">
                        ...
                        <li class="twitter"><a href="{{$contact->google}}"><i class="fa fa-twitter"></i></a></li>
                        <li class="google-plus"><a href="{{$contact->youtube}}"><i class="fa fa-google-plus"></i></a></li>
                        <li class="youtube"><a href="{{$contact->linkedin}}"><i class="fa fa-youtube-play"></i></a></li>
