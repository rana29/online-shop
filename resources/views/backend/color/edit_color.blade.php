                                            ...
                                            <form class="form-horizontal" method="post" action="{{route('color.update',$color->id)}}">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-3 col-sm-9 ">
                                                        ...
                                                        <a href="#rana{{$color->id}}" data-toggle="modal" class="btn btn-success">Update color</a>
                                                    </div>
                                                </div>
                                                ...
                                                <!---------------- data modal for edit -------------------------->
                                                 ...
                                                 <div class="modal fade" id="rana{{$color->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
