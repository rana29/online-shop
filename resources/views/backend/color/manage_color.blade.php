...
<div class="content-header">
    ...
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            ...
            <li><a href="javascript:avoid(0)">Manage-color</a></li>
        </ul>
    </div>
</div>
<!-- =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= -->
    ...
    <div class="col-sm-12 col-md-8 col-md-offset-2">
     ...
     <div class="panel b-primary bt-md">
        <div class="panel-content">
            <div class="row">
                <div class="col-xs-6">
                    <h4 class="text-success">Manage color</h4>
                </div>
                    ...
                    <table id="basic-table" class="data-table table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>              
                                    <a href="{{route('color.edit',$row->id)}}"  class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
                                      ...
                                      <a href="{{route('color.delete',$row->id)}}" id="delete" class="btn btn-success btn-xs "><i class="fa fa-trash"></i></a>
                                </td>
