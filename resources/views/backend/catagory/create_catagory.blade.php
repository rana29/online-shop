                                        ...
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="{{route('catagory.store')}}">
                                                ...
                                                <div class="form-group">
                                                    <label for="catagory" class="col-sm-3 control-label">Catagory</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="catagory_name" id="catagory" placeholder="Add catagory" value="{{old('catagory_name')}}">
                                                    </div>
                                                </div>
