                    ...
                    <table id="basic-table" class="data-table table table-striped table-hover table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>              
                                    <a href="{{route('brand.edit',$row->id)}}" class="btn btn-success btn-xs"><i class="fa fa-pencil"></i></a>
                                      ...
                                      <a href="{{route('brand.delete',$row->id)}}" id="delete" class="btn btn-success btn-xs "><i class="fa fa-trash"></i></a>
                                </td>
...
<!-- 
                                               <div class="modal fade" id="delete{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                  ...
                                                  <div class="modal-body">
                                                    <form method="post" action="{{route('brand.delete',$row->id)}}">
                                                      @csrf
