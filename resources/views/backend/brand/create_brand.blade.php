                        ...
                        <div class="col-sm-12 col-md-8 col-md-offset-2">
                            ...
                            <div class="panel b-primary bt-md">
                                <div class="panel-content">
                                    <div class="row">
                                        <div class="col-xs-6"><h4 class="text-primary">Brand Add Form</h4></div>
                                        ...
                                        <div class="col-md-12">
                                            <form class="form-horizontal" method="post" action="{{route('brand.store')}}">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="Brand_name" id="Brand" placeholder="Add Brand" value="{{old('Brand_name')}}">
                                                    </div>
                                                </div>
